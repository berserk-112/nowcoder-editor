...
public class Config {
    ...
    public Color[] getFormatLevelColour() {
        Color[] formatColors = new Color[5];
        formatColors[0] = new Color(153, 153, 153);
        formatColors[1] = new Color(59, 151, 255);
        formatColors[2] = new Color(50, 202, 153);
        formatColors[3] = new Color(255, 170, 32);
        formatColors[4] = new Color(255, 86, 28);
